...
| 音准线 | 压扁成上部一条扁平窄带(高≤两行歌词),只示旋律趋势;**可遥控显隐 + 跨重启缓存**(手机遥控页开关)。高亮**唱过染色(青)、没唱是白**,正在唱的块填到播放头处;**粗细/黑描边与歌词笔画看齐**(PC 端)。**起唱竖线→音高游标**:播放头处白色圆亮点+柔和光晕,y 随当前音符上下滑动、无音符落底部等待 | 2026-07-14 压扁+显隐;2026-07-15 手机端配色对齐 PC;PC 端音准线加粗描边看齐歌词 + 竖线改音高游标(亮点+光晕) |
