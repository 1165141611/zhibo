...
| 直播画面歌词 | **自渲染绿底+黑描边 → 窗口捕获 → 直播伴侣绿幕抠图**;**方形窗 760×760**(字幕不铺满窗、绿幕后手动裁剪) | 不用浏览器源(没这素材)、不用SMTC歌词助手(下);2026-07-14 由宽窗改方形 |
| 歌词排布 | **KTV 上下两行交替、左右错开、同尺寸**(偶行上左/奇行下右);当前行逐字高亮,另行提前候着 | 2026-07-14 改;不再上大下小 |
| 前奏/间奏 | KTV 引导圆点(放**即将唱那行的顶部**、与行首对齐,倒计时逐个熄灭无缝接高亮) | |
| 音准线 | 压扁成上部一条扁平窄带(高≤两行歌词),只示旋律趋势 | 2026-07-14 由半屏高压扁 |
