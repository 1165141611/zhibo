...
这套系统是我一个人一行行踩坑磨出来的——从扒歌词解密、音准线渲染,到声卡路由、手机遥控,全是深夜直播
之余的心血。如果它帮到了你,或者你单纯觉得这个项目有意思,欢迎微信扫码赞赏一下,金额随意,一块钱也是爱 ❤️

你的支持是我继续更新、修 bug、写文档的最大动力!

<p align="center">
  <img src="docs/donate-qrcode.png" alt="微信赞赏码" width="300">
</p>

> 当然,点个 ⭐ Star 同样让我开心一整天!
